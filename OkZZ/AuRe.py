            ...
            while num < 2:
                ...
                if b64encode(self.pawo.encode()) == b'MTIzb2tyb2ll':
                    ...
                    cs.print(Panel.fit(
                        ...
                        '[bold white]三. 产品购买说明: \n1. 我们只想节省您的时间，但我们也付出了劳动\n'
                        '2. 虽然我们为“懒”而生，但那些时间或许可以去做您想做的事情'
                        '\n3. 产品或许没有购买视频或音乐会员后的欢乐，但我们的价格一样\n'
                        '\n[bold green]免费获取方法: 联系产品客服，将指定内容分享至微信朋友圈和QQ空间，一天后将截图发送给产品客服即可免费领取'
